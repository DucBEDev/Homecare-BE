...
async function seedDatabase() {
    try {
        // Connect to MongoDB
        await mongoose.connect('mongodb+srv://nckhe222024:nckhe222024@procleaner.pire4.mongodb.net/?retryWrites=true&w=majority&appName=Procleaner');
        ...
        const staffs = [
            {
                ...
                birthPlace: "Hà Nội",
                avatar: "https://res.cloudinary.com/dakgqiwyd/image/upload/v1756953815/avatar_ryrfez.jpg",
                salary: 15000000,
        ...
        const helpers = [
            {
                ...
                jobs: [
                    insertedServices.find(service => service.title === "Chăm sóc người cao tuổi")._id,
                    insertedServices.find(service => service.title === "Dọn dẹp nhà cửa")._id
                ],
                yearOfExperience: 5,
                experienceDescription: "5 năm kinh nghiệm chăm sóc người cao tuổi và dọn dẹp nhà cửa",
                avatar: "https://res.cloudinary.com/dakgqiwyd/image/upload/v1756953815/avatar_ryrfez.jpg",
                healthCertificates: [
                    "https://res.cloudinary.com/dakgqiwyd/image/upload/v1756953815/avatar_ryrfez.jpg"
                ],
                gender: "Nữ",
